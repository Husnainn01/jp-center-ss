      ...
      <div className="flex items-start justify-between">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <Badge variant="outline" className="text-[10px]">{auction.source?.toUpperCase()}</Badge>
        ...
        <div className="text-right space-y-2">
          ...
          <p className="text-xs text-muted-foreground">{auction.auctionDate} · {auction.auctionHouse}</p>
